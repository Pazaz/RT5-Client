...
public final class Class112 {
	...
	public void method2916(@OriginalArg(0) RasteriserBase arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	private void method2918(@OriginalArg(0) RasteriserBase arg0, @OriginalArg(1) Class112 arg1) {
		...
		@Pc(94) int local94;
		if (this.anInt2875 != 0) {
			local79 = RasteriserBase.anIntArray178[this.anInt2875];
			local84 = RasteriserBase.anIntArray177[this.anInt2875];
			local94 = local33 * local84 - local35 * local79 >> 15;
			local35 = local33 * local79 + local35 * local84 >> 15;
			local33 = local94;
		}
		if (this.anInt2871 != 0) {
			local79 = RasteriserBase.anIntArray178[this.anInt2871];
			local84 = RasteriserBase.anIntArray177[this.anInt2871];
	...
	private void method2919(@OriginalArg(0) RasteriserBase arg0, @OriginalArg(1) Class112 arg1) {
		...
		if (this.anInt2875 != 0) {
			...
			local85 = RasteriserBase.anIntArray178[local81];
			local89 = RasteriserBase.anIntArray177[local81];
	...
	private boolean method2922(@OriginalArg(0) RasteriserBase arg0, @OriginalArg(1) Class112 arg1) {
		if (this.aClass13_11 == null) {
			if (this.anInt2877 == 0) {
	...
	public boolean method2924(@OriginalArg(0) RasteriserBase arg0, @OriginalArg(1) Class112 arg1) {
