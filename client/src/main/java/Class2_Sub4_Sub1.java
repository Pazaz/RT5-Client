...
public final class Class2_Sub4_Sub1 extends Buffer {
	...
	public void method3058(@OriginalArg(0) float arg0) {
		...
		this.aByteArray73[this.position++] = (byte) local6;
		this.aByteArray73[this.position++] = (byte) (local6 >> 8);
		this.aByteArray73[this.position++] = (byte) (local6 >> 16);
		this.aByteArray73[this.position++] = (byte) (local6 >> 24);
	}
	...
	public void method3059(@OriginalArg(0) float arg0) {
		...
		this.aByteArray73[this.position++] = (byte) (local2 >> 24);
		this.aByteArray73[this.position++] = (byte) (local2 >> 16);
		this.aByteArray73[this.position++] = (byte) (local2 >> 8);
		this.aByteArray73[this.position++] = (byte) local2;
	}
}
