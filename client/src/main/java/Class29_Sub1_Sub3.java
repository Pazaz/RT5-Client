...
public final class Class29_Sub1_Sub3 extends Class29_Sub1 {

	@OriginalMember(owner = "client!qd", name = "C", descriptor = "[I")
	private final int[] anIntArray397;

	@OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lclient!cs;[III)V")
	public Class29_Sub1_Sub3(@OriginalArg(0) Class40_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		super(arg0, arg2, arg3);
		this.anIntArray397 = arg1;
	}

	@OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lclient!cs;[IIIII)V")
	public Class29_Sub1_Sub3(@OriginalArg(0) Class40_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (super.aClass40_Sub1_9.method1233()) {
			...
			if (arg6 != 0) {
					...
					if (arg4 == 0) {
						...
						for (local261 = -arg3; local261 < 0; local261++) {
							...
							for (local272 = -arg2; local272 < 0; local272++) {
								local330 = this.anIntArray397[(local14 >> 16) + local269];
				...
				for (local261 = -arg3; local261 < 0; local261++) {
					local269 = (local16 >> 16) * super.anInt5388;
					for (local272 = -arg2; local272 < 0; local272++) {
						local252[local64++] = this.anIntArray397[(local14 >> 16) + local269];
						local14 += local44;
					}
					local16 += local50;
					local14 = local258;
	...
	public void method5833(@OriginalArg(2) int arg0) {
		...
		@Pc(25) int local25;
		if (arg0 == 0) {
			local5 = super.aClass40_Sub1_9.anIntArray90;
			for (local7 = 0; local7 < super.anInt5394; local7++) {
				local13 = local7 * super.anInt5388;
				local23 = local7 * super.aClass40_Sub1_9.anInt1412;
	...
	@OriginalMember(owner = "client!qd", name = "a", descriptor = "(IILclient!sn;II)V")
	@Override
		...
		if (arg2 == 0) {
			for (local424 = -local32; local424 < 0; local424++) {
				for (local428 = -local35; local428 < 0; local428++) {
					local435 = this.anIntArray397[local29++];
		...
		if (arg2 == 1) {
			if ((arg3 & 0xFFFFFF) == 16777215) {
				...
				for (local439 = -local32; local439 < 0; local439++) {
					for (local443 = -local35; local443 < 0; local443++) {
						local447 = this.anIntArray397[local29++];
			...
			for (local443 = -local32; local443 < 0; local443++) {
				for (local447 = -local35; local447 < 0; local447++) {
					local623 = this.anIntArray397[local29++];
	...
	protected void method4587(@OriginalArg(0) int arg0) {
		...
		if (Static34.anInt5377 == 0) {
			if (Static34.anInt5390 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt5388 << 12) < 0 && local16 - (super.anInt5394 << 12) < 0) {
						while (local18 < 0) {
							...
							local51 = local12++;
							if (arg0 == 0) {
								local162 = this.anIntArray397[local48];
								...
								local162 = this.anIntArray397[local48];
								local166 = (local162 >>> 24) * Static34.anInt5371 >> 8;
								local170 = 256 - local166;
								if ((Static34.anInt5385 & 0xFFFFFF) == 16777215) {
									local174 = local3[local51];
									local3[local51] = ((local162 & 0xFF00FF) * local166 + (local174 & 0xFF00FF) * local170 & 0xFF00FF00) + ((local162 & 0xFF00) * local166 + (local174 & 0xFF00) * local170 & 0xFF0000) >> 8;
								} else if (Static34.anInt5371 == 255) {
									local174 = (local162 & 0xFF0000) * Static34.anInt5374 & 0xFF000000;
									local288 = (local162 & 0xFF00) * Static34.anInt5400 & 0xFF0000;
									local296 = (local162 & 0xFF) * Static34.anInt5383 & 0xFF00;
								...
								local166 = local162 >>> 24;
								local170 = 256 - local166;
								local174 = (local162 & 0xFF00FF) * Static34.anInt5371 & 0xFF00FF00;
								local288 = (local162 & 0xFF00) * Static34.anInt5371 & 0xFF0000;
								local162 = ((local174 | local288) >>> 8) + Static34.anInt5381;
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt5388 << 12) < 0) {
						@Pc(703) int local703;
						if ((local703 = local16 - (super.anInt5394 << 12)) >= 0) {
							local710 = (Static34.anInt5390 - local703) / Static34.anInt5390;
							local18 += local710;
							local16 += Static34.anInt5390 * local710;
							local12 += local710;
						}
						@Pc(731) int local731;
						if ((local731 = (local16 - Static34.anInt5390) / Static34.anInt5390) > local18) {
							local18 = local731;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt5388 << 12) < 0) {
						if (local16 < 0) {
							local710 = (Static34.anInt5390 - local16 - 1) / Static34.anInt5390;
							local18 += local710;
							local16 += Static34.anInt5390 * local710;
							local12 += local710;
						}
						@Pc(1438) int local1438;
						if ((local1438 = (local16 + 1 - (super.anInt5394 << 12) - Static34.anInt5390) / Static34.anInt5390) > local18) {
							local18 = local1438;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
			...
			if (Static34.anInt5390 == 0) {
				...
				while (local9 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt5394 << 12) < 0) {
						...
						if ((local2119 = local14 - (super.anInt5388 << 12)) >= 0) {
							local710 = (Static34.anInt5377 - local2119) / Static34.anInt5377;
							local18 += local710;
							local14 += Static34.anInt5377 * local710;
							local12 += local710;
						}
						@Pc(2147) int local2147;
						if ((local2147 = (local14 - Static34.anInt5377) / Static34.anInt5377) > local18) {
							local18 = local2147;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local2819 = local14 - (super.anInt5388 << 12)) >= 0) {
						local710 = (Static34.anInt5377 - local2819) / Static34.anInt5377;
						local18 += local710;
						local14 += Static34.anInt5377 * local710;
						local16 += Static34.anInt5390 * local710;
						local12 += local710;
					...
					if ((local2853 = (local14 - Static34.anInt5377) / Static34.anInt5377) > local18) {
						local18 = local2853;
					}
					@Pc(2865) int local2865;
					if ((local2865 = local16 - (super.anInt5394 << 12)) >= 0) {
						local710 = (Static34.anInt5390 - local2865) / Static34.anInt5390;
						local18 += local710;
						local14 += Static34.anInt5377 * local710;
						local16 += Static34.anInt5390 * local710;
						local12 += local710;
					...
					if ((local2899 = (local16 - Static34.anInt5390) / Static34.anInt5390) > local18) {
						local18 = local2899;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local3577 = local14 - (super.anInt5388 << 12)) >= 0) {
						local710 = (Static34.anInt5377 - local3577) / Static34.anInt5377;
						local18 += local710;
						local14 += Static34.anInt5377 * local710;
						local16 += Static34.anInt5390 * local710;
						local12 += local710;
					...
					if ((local3611 = (local14 - Static34.anInt5377) / Static34.anInt5377) > local18) {
						local18 = local3611;
					}
					if (local16 < 0) {
						local710 = (Static34.anInt5390 - local16 - 1) / Static34.anInt5390;
					...
					if ((local3659 = (local16 + 1 - (super.anInt5394 << 12) - Static34.anInt5390) / Static34.anInt5390) > local18) {
						local18 = local3659;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
			...
			while (local9 < 0) {
				...
				if (local16 >= 0 && local16 - (super.anInt5394 << 12) < 0) {
					if (local14 < 0) {
						local710 = (Static34.anInt5377 - local14 - 1) / Static34.anInt5377;
						local18 += local710;
						local14 += Static34.anInt5377 * local710;
						local12 += local710;
					}
					@Pc(4376) int local4376;
					if ((local4376 = (local14 + 1 - (super.anInt5388 << 12) - Static34.anInt5377) / Static34.anInt5377) > local18) {
						local18 = local4376;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
			...
			for (local9 = Static34.anInt5378; local9 < 0; local9++) {
				...
				if ((local5088 = (local14 + 1 - (super.anInt5388 << 12) - Static34.anInt5377) / Static34.anInt5377) > local18) {
					local18 = local5088;
				}
				@Pc(5100) int local5100;
				if ((local5100 = local16 - (super.anInt5394 << 12)) >= 0) {
					local710 = (Static34.anInt5390 - local5100) / Static34.anInt5390;
					local18 += local710;
					local14 += Static34.anInt5377 * local710;
					local16 += Static34.anInt5390 * local710;
					local12 += local710;
				...
				if ((local5134 = (local16 - Static34.anInt5390) / Static34.anInt5390) > local18) {
					local18 = local5134;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
			...
			for (local9 = Static34.anInt5378; local9 < 0; local9++) {
				...
				if ((local5848 = (local14 + 1 - (super.anInt5388 << 12) - Static34.anInt5377) / Static34.anInt5377) > local18) {
					local18 = local5848;
				}
				if (local16 < 0) {
					local710 = (Static34.anInt5390 - local16 - 1) / Static34.anInt5390;
				...
				if ((local5896 = (local16 + 1 - (super.anInt5394 << 12) - Static34.anInt5390) / Static34.anInt5390) > local18) {
					local18 = local5896;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
		...
		if (Static34.anInt5377 == 0) {
			if (Static34.anInt5390 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt5388 << 12) < 0 && local27 - (super.anInt5394 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.anIntArray397[(local27 >> 12) * super.anInt5388 + (local25 >> 12)];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt5388 << 12) < 0) {
							@Pc(210) int local210;
							if ((local210 = local27 - (super.anInt5394 << 12)) >= 0) {
								local217 = (Static34.anInt5390 - local210) / Static34.anInt5390;
								local29 += local217;
								local27 += Static34.anInt5390 * local217;
								local23 += local217;
							}
							@Pc(238) int local238;
							if ((local238 = (local27 - Static34.anInt5390) / Static34.anInt5390) > local29) {
								local29 = local238;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt5388 << 12) < 0) {
							if (local27 < 0) {
								local217 = (Static34.anInt5390 - local27 - 1) / Static34.anInt5390;
								local29 += local217;
								local27 += Static34.anInt5390 * local217;
								local23 += local217;
							}
							@Pc(441) int local441;
							if ((local441 = (local27 + 1 - (super.anInt5394 << 12) - Static34.anInt5390) / Static34.anInt5390) > local29) {
								local29 = local441;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt5394 << 12) < 0) {
							...
							if ((local618 = local25 - (super.anInt5388 << 12)) >= 0) {
								local217 = (Static34.anInt5377 - local618) / Static34.anInt5377;
								local29 += local217;
								local25 += Static34.anInt5377 * local217;
								local23 += local217;
							}
							@Pc(646) int local646;
							if ((local646 = (local25 - Static34.anInt5377) / Static34.anInt5377) > local29) {
								local29 = local646;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if ((local814 = local25 - (super.anInt5388 << 12)) >= 0) {
							local217 = (Static34.anInt5377 - local814) / Static34.anInt5377;
							local29 += local217;
							local25 += Static34.anInt5377 * local217;
							local27 += Static34.anInt5390 * local217;
							local23 += local217;
						...
						@Pc(848) int local848;
						if ((local848 = (local25 - Static34.anInt5377) / Static34.anInt5377) > local29) {
							local29 = local848;
						}
						@Pc(860) int local860;
						if ((local860 = local27 - (super.anInt5394 << 12)) >= 0) {
							local217 = (Static34.anInt5390 - local860) / Static34.anInt5390;
							local29 += local217;
							local25 += Static34.anInt5377 * local217;
							local27 += Static34.anInt5390 * local217;
							local23 += local217;
						...
						@Pc(894) int local894;
						if ((local894 = (local27 - Static34.anInt5390) / Static34.anInt5390) > local29) {
							local29 = local894;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if ((local1068 = local25 - (super.anInt5388 << 12)) >= 0) {
							local217 = (Static34.anInt5377 - local1068) / Static34.anInt5377;
							local29 += local217;
							local25 += Static34.anInt5377 * local217;
							local27 += Static34.anInt5390 * local217;
							local23 += local217;
						...
						if ((local1102 = (local25 - Static34.anInt5377) / Static34.anInt5377) > local29) {
							local29 = local1102;
						}
						if (local27 < 0) {
							local217 = (Static34.anInt5390 - local27 - 1) / Static34.anInt5390;
						...
						if ((local1150 = (local27 + 1 - (super.anInt5394 << 12) - Static34.anInt5390) / Static34.anInt5390) > local29) {
							local29 = local1150;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt5394 << 12) < 0) {
						if (local25 < 0) {
							local217 = (Static34.anInt5377 - local25 - 1) / Static34.anInt5377;
							local29 += local217;
							local25 += Static34.anInt5377 * local217;
							local23 += local217;
						}
						@Pc(1363) int local1363;
						if ((local1363 = (local25 + 1 - (super.anInt5388 << 12) - Static34.anInt5377) / Static34.anInt5377) > local29) {
							local29 = local1363;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1571 = (local25 + 1 - (super.anInt5388 << 12) - Static34.anInt5377) / Static34.anInt5377) > local29) {
						local29 = local1571;
					}
					@Pc(1583) int local1583;
					if ((local1583 = local27 - (super.anInt5394 << 12)) >= 0) {
						local217 = (Static34.anInt5390 - local1583) / Static34.anInt5390;
						local29 += local217;
						local25 += Static34.anInt5377 * local217;
						local27 += Static34.anInt5390 * local217;
						local23 += local217;
					...
					if ((local1617 = (local27 - Static34.anInt5390) / Static34.anInt5390) > local29) {
						local29 = local1617;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1827 = (local25 + 1 - (super.anInt5388 << 12) - Static34.anInt5377) / Static34.anInt5377) > local29) {
						local29 = local1827;
					}
					if (local27 < 0) {
						local217 = (Static34.anInt5390 - local27 - 1) / Static34.anInt5390;
					...
					if ((local1875 = (local27 + 1 - (super.anInt5394 << 12) - Static34.anInt5390) / Static34.anInt5390) > local29) {
						local29 = local1875;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
