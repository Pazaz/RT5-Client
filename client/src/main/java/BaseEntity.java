...
public abstract class BaseEntity {
	...
	public abstract boolean method6068(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class19 arg2);
	...
	public abstract void method6070(@OriginalArg(0) Class19 arg0);

	@OriginalMember(owner = "client!hp", name = "b", descriptor = "(Lclient!wm;B)Lclient!nf;")
	public abstract Class12_Sub4 method6073(@OriginalArg(0) Class19 arg0);

	@OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIILclient!wm;ZLclient!hp;Z)V")
	public abstract void method6075(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class19 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) BaseEntity arg5);
