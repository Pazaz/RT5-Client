...
public class Class221 {
	...
	public final synchronized void method6316() {
		...
		try {
			if (this.aLong225 != 0L) {
				...
				this.method6332(this.anInt7099);
				this.aLong225 = 0L;
			...
			while (local103 > local83) {
				this.method6323(this.anIntArray485);
				this.method6329();
				local83 += 256;
			}
	...
	private void method6320(@OriginalArg(0) Class2_Sub12 arg0, @OriginalArg(2) int arg1) {
						...
						label97: while (true) {
							while (true) {
								...
								if (local97 == null || local97.anInt3175 <= local61) {
									...
									@Pc(140) Class2_Sub12 local140 = local93.method4978();
									if (local140 != null) {
