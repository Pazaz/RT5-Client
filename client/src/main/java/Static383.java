	...
	public static void method6379(@OriginalArg(0) String arg0) {
		...
		try {
			...
			if (arg0.length() == 0) {
				...
				local40 = local40 + "; Expires=" + Static15.method393(Static204.method3685() + 94608000000L) + "; Max-Age=" + 94608000L;
			}
			Static405.method4629("document.cookie=\"" + local40 + "\"", Static328.aClass152_5.anApplet1);
