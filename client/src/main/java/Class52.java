...
public final class Class52 {
	...
	private void method1767(@OriginalArg(0) Class2_Sub4 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
			...
			this.anInt1634 = arg0.method4836();
			...
			for (@Pc(55) int local55 = 0; local55 < local45; local55++) {
				@Pc(61) int local61 = arg0.method4836();
				@Pc(73) Class2 local73;
				if (arg1 == 5) {
					local73 = new Class2_Sub40(arg0.method4809());
				} else {
					local73 = new Class2_Sub39(arg0.method4836());
				}
	...
	public boolean method1769(@OriginalArg(1) String arg0) {
		...
		for (@Pc(37) Class2_Sub28 local37 = (Class2_Sub28) this.aClass4_30.method90(Static80.method5982(arg0)); local37 != null; local37 = (Class2_Sub28) this.aClass4_30.method82()) {
	...
	private void method1773() {
		...
		for (@Pc(28) Class2_Sub40 local28 = (Class2_Sub40) this.aClass4_31.method80(); local28 != null; local28 = (Class2_Sub40) this.aClass4_31.method79()) {
			...
			this.aClass4_30.method87(local39, Static80.method5982(local28.aString65));
		}
	}
