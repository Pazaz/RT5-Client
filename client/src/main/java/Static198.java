...
public final class Static198 {
	...
	private static void method3592(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		...
		Protocol.method1960(Static102.aClass145_141);
						...
						if (arg0 < 2800) {
							...
							if (arg0 < 3200) {
								...
								if (arg0 == 3104) {
									...
									Protocol.method1960(Static363.aClass145_239);
									Protocol.outboundBuffer.p4(local19);
									return;
								}
								if (arg0 == 3105) {
									local3493 = aStringArray29[--anInt3652];
									Protocol.method1960(Static49.aClass145_44);
								...
								if (arg0 == 3106) {
									local3493 = aStringArray29[--anInt3652];
									Protocol.method1960(Static221.aClass145_164);
									Protocol.outboundBuffer.p1(local3493.length() + 1);
									Protocol.outboundBuffer.pjstr(local3493);
									return;
								}
								...
								if (arg0 == 3110) {
									local13 = anIntArray213[--anInt3650];
									Protocol.method1960(Static190.aClass145_138);
	...
	private static void runScript(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		...
		if (arg0 < 5100) {
			...
			if (arg0 == 5001) {
				...
				Protocol.method1960(Static32.aClass145_32);
			...
			if (arg0 == 5002) {
				...
				Protocol.method1960(Static327.aClass145_222);
			...
			if (arg0 == 5009) {
				...
				local81 = aStringArray29[anInt3652 + 1];
				if (LoginManager.staffModLevel != 0 || (!LoginManager.playerUnderage || LoginManager.parentalChatConsent) && !LoginManager.mapQuickChat) {
					Protocol.method1960(Static382.aClass145_261);
					Protocol.outboundBuffer.p1(0);
			...
			if (arg0 == 5059) {
				Protocol.method1960(Static369.aClass145_248);
				Protocol.outboundBuffer.p1(0);
			...
			if (arg0 == 5060) {
				local75 = aStringArray29[--anInt3652];
				Protocol.method1960(Static325.aClass145_220);
				Protocol.outboundBuffer.p1(0);
				...
				if (arg0 < 5400) {
					...
					if (arg0 < 5500) {
						if (arg0 == 5400) {
							...
							local81 = aStringArray29[anInt3652 + 1];
							local89 = anIntArray213[--anInt3650];
							Protocol.method1960(Static323.aClass145_219);
						...
						if (arg0 == 5603) {
							...
							if (Static154.anInt2803 == 0 && LoginManager.step == 0 && CreateManager.step == 0 && WorldList.step == 0) {
								CreateManager.checkInfo(anIntArray213[anInt3650 + 3], anIntArray213[anInt3650 + 2], anIntArray213[anInt3650], anIntArray213[anInt3650 + 1]);
								return;
							}
							return;
						}
						if (arg0 == 5604) {
							...
							if (Static154.anInt2803 == 0 && LoginManager.step == 0 && CreateManager.step == 0 && WorldList.step == 0) {
								CreateManager.checkName(StringUtils.toBase37(aStringArray29[anInt3652]));
								return;
							}
							return;
						}
						...
						if (arg0 == 5607) {
							anIntArray213[anInt3650++] = LoginManager.reply;
							return;
						}
						if (arg0 == 5608) {
						...
						if (arg0 == 5609) {
							anIntArray213[anInt3650++] = CreateManager.reply;
							return;
						}
						if (arg0 == 5610) {
							for (local157 = 0; local157 < 5; local157++) {
								aStringArray29[anInt3652++] = CreateManager.suggestedNames.length > local157 ? Static330.method5657(CreateManager.suggestedNames[local157]) : "";
							}
