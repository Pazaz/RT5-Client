...
public final class Class29_Sub1_Sub2 extends Class29_Sub1 {
	...
	@OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lclient!cs;[B[III)V")
	public Class29_Sub1_Sub2(@OriginalArg(0) Class40_Sub1 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (super.aClass40_Sub1_9.method1233()) {
			...
			if (arg6 != 0) {
				...
				if (arg6 == 1) {
					if (arg4 == 0) {
						...
						for (local261 = -arg3; local261 < 0; local261++) {
							...
							for (local272 = -arg2; local272 < 0; local272++) {
								local564 = this.aByteArray39[(local14 >> 16) + local269];
								if (local564 == 0) {
									local64++;
								} else {
									local252[local64++] = this.anIntArray294[local564 & 0xFF];
								}
								local14 += local44;
							}
							local16 += local50;
						...
						if ((arg5 & 0xFFFFFF) == 16777215) {
							...
							for (local272 = -arg3; local272 < 0; local272++) {
								...
								for (local343 = -arg2; local343 < 0; local343++) {
									@Pc(641) byte local641 = this.aByteArray39[(local14 >> 16) + local335];
									if (local641 == 0) {
										local64++;
									} else {
										local361 = this.anIntArray294[local641 & 0xFF];
							...
							for (local346 = -arg3; local346 < 0; local346++) {
								...
								for (local369 = -arg2; local369 < 0; local369++) {
									@Pc(758) byte local758 = this.aByteArray39[(local14 >> 16) + local361];
									if (local758 == 0) {
										local64++;
									} else {
										local385 = this.anIntArray294[local758 & 0xFF];
										if (local335 == 255) {
					...
					for (local261 = -arg3; local261 < 0; local261++) {
						...
						for (local272 = -arg2; local272 < 0; local272++) {
							...
							if (local564 == 0) {
								...
								local343 = this.anIntArray294[local564 & 0xFF];
					...
					for (local335 = -arg3; local335 < 0; local335++) {
						...
						for (local346 = -arg2; local346 < 0; local346++) {
							@Pc(1167) byte local1167 = this.aByteArray39[(local14 >> 16) + local343];
							if (local1167 == 0) {
								local64++;
							} else {
								local369 = this.anIntArray294[local1167 & 0xFF];
				...
				for (local261 = -arg3; local261 < 0; local261++) {
					local269 = (local16 >> 16) * super.anInt5388;
					for (local272 = -arg2; local272 < 0; local272++) {
						local252[local64++] = this.anIntArray294[this.aByteArray39[(local14 >> 16) + local269] & 0xFF];
						local14 += local44;
					}
					local16 += local50;
					local14 = local258;
				...
				for (local335 = -arg3; local335 < 0; local335++) {
					local343 = (local16 >> 16) * super.anInt5388;
					for (local346 = -arg2; local346 < 0; local346++) {
						local361 = this.anIntArray294[this.aByteArray39[(local14 >> 16) + local343] & 0xFF];
	...
	protected void method4587(@OriginalArg(0) int arg0) {
		...
		if (Static34.anInt5377 == 0) {
			if (Static34.anInt5390 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt5388 << 12) < 0 && local16 - (super.anInt5394 << 12) < 0) {
						while (local18 < 0) {
							...
							local51 = local12++;
							if (arg0 == 0) {
								local176 = this.aByteArray39[local48];
								if (local176 != 0) {
									local3[local51] = this.anIntArray294[local176 & 0xFF];
								}
							} else if (arg0 == 1) {
								local176 = this.aByteArray39[local48];
								if (local176 != 0) {
									local205 = this.anIntArray294[local176 & 0xFF];
									if ((Static34.anInt5385 & 0xFFFFFF) == 16777215) {
										local214 = Static34.anInt5385 >>> 24;
										...
										local214 = (local205 & 0xFF0000) * Static34.anInt5374 & 0xFF000000;
										local218 = (local205 & 0xFF00) * Static34.anInt5400 & 0xFF0000;
										local222 = (local205 & 0xFF) * Static34.anInt5383 & 0xFF00;
										...
										local3[local51] = ((local205 & 0xFF00FF) * Static34.anInt5371 + (local294 & 0xFF00FF) * Static34.anInt5386 & 0xFF00FF00) + ((local205 & 0xFF00) * Static34.anInt5371 + (local294 & 0xFF00) * Static34.anInt5386 & 0xFF0000) >> 8;
									}
								}
							} else if (arg0 == 2) {
								local176 = this.aByteArray39[local48];
								if (local176 != 0) {
									local205 = this.anIntArray294[local176 & 0xFF];
									local214 = (local205 & 0xFF00FF) * Static34.anInt5371 & 0xFF00FF00;
									local218 = (local205 & 0xFF00) * Static34.anInt5371 & 0xFF0000;
									local3[local51++] = ((local214 | local218) >>> 8) + Static34.anInt5381;
								}
							} else {
								throw new IllegalArgumentException();
							}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt5388 << 12) < 0) {
						@Pc(684) int local684;
						if ((local684 = local16 - (super.anInt5394 << 12)) >= 0) {
							local691 = (Static34.anInt5390 - local684) / Static34.anInt5390;
							local18 += local691;
							local16 += Static34.anInt5390 * local691;
							local12 += local691;
						}
						@Pc(712) int local712;
						if ((local712 = (local16 - Static34.anInt5390) / Static34.anInt5390) > local18) {
							local18 = local712;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt5388 << 12) < 0) {
						if (local16 < 0) {
							local691 = (Static34.anInt5390 - local16 - 1) / Static34.anInt5390;
							local18 += local691;
							local16 += Static34.anInt5390 * local691;
							local12 += local691;
						}
						@Pc(1400) int local1400;
						if ((local1400 = (local16 + 1 - (super.anInt5394 << 12) - Static34.anInt5390) / Static34.anInt5390) > local18) {
							local18 = local1400;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
			...
			if (Static34.anInt5390 == 0) {
				...
				while (local9 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt5394 << 12) < 0) {
						...
						if ((local2062 = local14 - (super.anInt5388 << 12)) >= 0) {
							local691 = (Static34.anInt5377 - local2062) / Static34.anInt5377;
							local18 += local691;
							local14 += Static34.anInt5377 * local691;
							local12 += local691;
						}
						@Pc(2090) int local2090;
						if ((local2090 = (local14 - Static34.anInt5377) / Static34.anInt5377) > local18) {
							local18 = local2090;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local2743 = local14 - (super.anInt5388 << 12)) >= 0) {
						local691 = (Static34.anInt5377 - local2743) / Static34.anInt5377;
						local18 += local691;
						local14 += Static34.anInt5377 * local691;
						local16 += Static34.anInt5390 * local691;
						local12 += local691;
					...
					if ((local2777 = (local14 - Static34.anInt5377) / Static34.anInt5377) > local18) {
						local18 = local2777;
					}
					@Pc(2789) int local2789;
					if ((local2789 = local16 - (super.anInt5394 << 12)) >= 0) {
						local691 = (Static34.anInt5390 - local2789) / Static34.anInt5390;
						local18 += local691;
						local14 += Static34.anInt5377 * local691;
						local16 += Static34.anInt5390 * local691;
						local12 += local691;
					...
					if ((local2823 = (local16 - Static34.anInt5390) / Static34.anInt5390) > local18) {
						local18 = local2823;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local3482 = local14 - (super.anInt5388 << 12)) >= 0) {
						local691 = (Static34.anInt5377 - local3482) / Static34.anInt5377;
						local18 += local691;
						local14 += Static34.anInt5377 * local691;
						local16 += Static34.anInt5390 * local691;
						local12 += local691;
					...
					if ((local3516 = (local14 - Static34.anInt5377) / Static34.anInt5377) > local18) {
						local18 = local3516;
					}
					if (local16 < 0) {
						local691 = (Static34.anInt5390 - local16 - 1) / Static34.anInt5390;
					...
					if ((local3564 = (local16 + 1 - (super.anInt5394 << 12) - Static34.anInt5390) / Static34.anInt5390) > local18) {
						local18 = local3564;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
			...
			while (local9 < 0) {
				...
				if (local16 >= 0 && local16 - (super.anInt5394 << 12) < 0) {
					if (local14 < 0) {
						local691 = (Static34.anInt5377 - local14 - 1) / Static34.anInt5377;
						local18 += local691;
						local14 += Static34.anInt5377 * local691;
						local12 += local691;
					}
					@Pc(4262) int local4262;
					if ((local4262 = (local14 + 1 - (super.anInt5388 << 12) - Static34.anInt5377) / Static34.anInt5377) > local18) {
						local18 = local4262;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
			...
			for (local9 = Static34.anInt5378; local9 < 0; local9++) {
				...
				if ((local4955 = (local14 + 1 - (super.anInt5388 << 12) - Static34.anInt5377) / Static34.anInt5377) > local18) {
					local18 = local4955;
				}
				@Pc(4967) int local4967;
				if ((local4967 = local16 - (super.anInt5394 << 12)) >= 0) {
					local691 = (Static34.anInt5390 - local4967) / Static34.anInt5390;
					local18 += local691;
					local14 += Static34.anInt5377 * local691;
					local16 += Static34.anInt5390 * local691;
					local12 += local691;
				...
				if ((local5001 = (local16 - Static34.anInt5390) / Static34.anInt5390) > local18) {
					local18 = local5001;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
			...
			for (local9 = Static34.anInt5378; local9 < 0; local9++) {
				...
				if ((local5696 = (local14 + 1 - (super.anInt5388 << 12) - Static34.anInt5377) / Static34.anInt5377) > local18) {
					local18 = local5696;
				}
				if (local16 < 0) {
					local691 = (Static34.anInt5390 - local16 - 1) / Static34.anInt5390;
				...
				if ((local5744 = (local16 + 1 - (super.anInt5394 << 12) - Static34.anInt5390) / Static34.anInt5390) > local18) {
					local18 = local5744;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt5388 + (local14 >> 12);
	...
	@OriginalMember(owner = "client!lp", name = "a", descriptor = "(IILclient!sn;II)V")
	@Override
		...
		for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
			...
			for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
				...
				if (local311 == 0) {
					...
					local169[local41++] = this.anIntArray294[local311 & 0xFF];
				}
			}
		...
		if (Static34.anInt5377 == 0) {
			if (Static34.anInt5390 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt5388 << 12) < 0 && local27 - (super.anInt5394 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.aByteArray39[(local27 >> 12) * super.anInt5388 + (local25 >> 12)];
								if (local111 == 0) {
									local23++;
								} else {
									local3[local23++] = this.anIntArray294[local111 & 0xFF];
								}
								local29++;
							}
						}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt5388 << 12) < 0) {
							@Pc(179) int local179;
							if ((local179 = local27 - (super.anInt5394 << 12)) >= 0) {
								local186 = (Static34.anInt5390 - local179) / Static34.anInt5390;
								local29 += local186;
								local27 += Static34.anInt5390 * local186;
								local23 += local186;
							}
							@Pc(207) int local207;
							if ((local207 = (local27 - Static34.anInt5390) / Static34.anInt5390) > local29) {
								local29 = local207;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt5388 << 12) < 0) {
							if (local27 < 0) {
								local186 = (Static34.anInt5390 - local27 - 1) / Static34.anInt5390;
								local29 += local186;
								local27 += Static34.anInt5390 * local186;
								local23 += local186;
							}
							@Pc(379) int local379;
							if ((local379 = (local27 + 1 - (super.anInt5394 << 12) - Static34.anInt5390) / Static34.anInt5390) > local29) {
								local29 = local379;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt5394 << 12) < 0) {
							...
							if ((local525 = local25 - (super.anInt5388 << 12)) >= 0) {
								local186 = (Static34.anInt5377 - local525) / Static34.anInt5377;
								local29 += local186;
								local25 += Static34.anInt5377 * local186;
								local23 += local186;
							}
							@Pc(553) int local553;
							if ((local553 = (local25 - Static34.anInt5377) / Static34.anInt5377) > local29) {
								local29 = local553;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if ((local690 = local25 - (super.anInt5388 << 12)) >= 0) {
							local186 = (Static34.anInt5377 - local690) / Static34.anInt5377;
							local29 += local186;
							local25 += Static34.anInt5377 * local186;
							local27 += Static34.anInt5390 * local186;
							local23 += local186;
						...
						@Pc(724) int local724;
						if ((local724 = (local25 - Static34.anInt5377) / Static34.anInt5377) > local29) {
							local29 = local724;
						}
						@Pc(736) int local736;
						if ((local736 = local27 - (super.anInt5394 << 12)) >= 0) {
							local186 = (Static34.anInt5390 - local736) / Static34.anInt5390;
							local29 += local186;
							local25 += Static34.anInt5377 * local186;
							local27 += Static34.anInt5390 * local186;
							local23 += local186;
						...
						@Pc(770) int local770;
						if ((local770 = (local27 - Static34.anInt5390) / Static34.anInt5390) > local29) {
							local29 = local770;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if ((local913 = local25 - (super.anInt5388 << 12)) >= 0) {
							local186 = (Static34.anInt5377 - local913) / Static34.anInt5377;
							local29 += local186;
							local25 += Static34.anInt5377 * local186;
							local27 += Static34.anInt5390 * local186;
							local23 += local186;
						...
						@Pc(947) int local947;
						if ((local947 = (local25 - Static34.anInt5377) / Static34.anInt5377) > local29) {
							local29 = local947;
						}
						if (local27 < 0) {
							local186 = (Static34.anInt5390 - local27 - 1) / Static34.anInt5390;
						...
						@Pc(995) int local995;
						if ((local995 = (local27 + 1 - (super.anInt5394 << 12) - Static34.anInt5390) / Static34.anInt5390) > local29) {
							local29 = local995;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt5394 << 12) < 0) {
						if (local25 < 0) {
							local186 = (Static34.anInt5377 - local25 - 1) / Static34.anInt5377;
							local29 += local186;
							local25 += Static34.anInt5377 * local186;
							local23 += local186;
						}
						@Pc(1177) int local1177;
						if ((local1177 = (local25 + 1 - (super.anInt5388 << 12) - Static34.anInt5377) / Static34.anInt5377) > local29) {
							local29 = local1177;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1354 = (local25 + 1 - (super.anInt5388 << 12) - Static34.anInt5377) / Static34.anInt5377) > local29) {
						local29 = local1354;
					}
					@Pc(1366) int local1366;
					if ((local1366 = local27 - (super.anInt5394 << 12)) >= 0) {
						local186 = (Static34.anInt5390 - local1366) / Static34.anInt5390;
						local29 += local186;
						local25 += Static34.anInt5377 * local186;
						local27 += Static34.anInt5390 * local186;
						local23 += local186;
					...
					@Pc(1400) int local1400;
					if ((local1400 = (local27 - Static34.anInt5390) / Static34.anInt5390) > local29) {
						local29 = local1400;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1579 = (local25 + 1 - (super.anInt5388 << 12) - Static34.anInt5377) / Static34.anInt5377) > local29) {
						local29 = local1579;
					}
					if (local27 < 0) {
						local186 = (Static34.anInt5390 - local27 - 1) / Static34.anInt5390;
					...
					if ((local1627 = (local27 + 1 - (super.anInt5394 << 12) - Static34.anInt5390) / Static34.anInt5390) > local29) {
						local29 = local1627;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
		...
		if (arg2 == 0) {
			for (local459 = -local32; local459 < 0; local459++) {
				...
				while (local27 < local466) {
					local473 = this.aByteArray39[local29++];
					if (local473 == 0) {
						local27++;
					} else {
						local160[local27++] = this.anIntArray294[local473 & 0xFF];
					}
					local473 = this.aByteArray39[local29++];
					if (local473 == 0) {
						local27++;
		...
		if (arg2 == 1) {
			...
			if ((arg3 & 0xFFFFFF) == 16777215) {
				...
				for (local606 = -local32; local606 < 0; local606++) {
					for (local610 = -local35; local610 < 0; local610++) {
						@Pc(617) byte local617 = this.aByteArray39[local29++];
						if (local617 == 0) {
							local27++;
						} else {
							local626 = this.anIntArray294[local617 & 0xFF];
				...
				for (local626 = -local32; local626 < 0; local626++) {
					for (local630 = -local35; local630 < 0; local630++) {
						@Pc(718) byte local718 = this.aByteArray39[local29++];
						if (local718 == 0) {
							local27++;
						} else {
							@Pc(727) int local727 = this.anIntArray294[local718 & 0xFF];
							@Pc(738) int local738;
							@Pc(746) int local746;
							@Pc(754) int local754;
							if (local610 == 255) {
			...
			for (local704 = -local32; local704 < 0; local704++) {
				for (local626 = -local35; local626 < 0; local626++) {
					@Pc(899) byte local899 = this.aByteArray39[local29++];
					if (local899 == 0) {
						local27++;
					} else {
						@Pc(908) int local908 = this.anIntArray294[local899 & 0xFF];
