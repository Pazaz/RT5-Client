...
public class Class2_Sub4 extends Class2 {
	...
	public final long method4798() {
		@Pc(10) long local10 = (long) this.method4836() & 0xFFFFFFFFL;
		@Pc(19) long local19 = (long) this.method4836() & 0xFFFFFFFFL;
	...
	public final int method4802(@OriginalArg(0) int arg0) {
		@Pc(18) int local18 = Static80.method5981(this.anInt5300, arg0, this.aByteArray73);
		this.method4813(local18);
		return local18;
	}
	...
	public final boolean method4808() {
		this.anInt5300 -= 4;
		@Pc(23) int local23 = Static80.method5981(this.anInt5300, 0, this.aByteArray73);
		@Pc(27) int local27 = this.method4836();
	...
	public final void method4813(@OriginalArg(1) int arg0) {
		this.aByteArray73[this.anInt5300++] = (byte) (arg0 >> 24);
		this.aByteArray73[this.anInt5300++] = (byte) (arg0 >> 16);
		this.aByteArray73[this.anInt5300++] = (byte) (arg0 >> 8);
		this.aByteArray73[this.anInt5300++] = (byte) arg0;
	...
	public final int method4817() {
		...
		return local16 >= 128 ? this.method4829() - 32768 : this.method4815();
	}
	...
	public final int method4818() {
		...
		return local19 >= 128 ? this.method4829() - 49152 : this.method4815() + -64;
	}
	...
	public final void method4821(@OriginalArg(2) int[] arg0, @OriginalArg(3) int arg1) {
		...
		for (@Pc(27) int local27 = 0; local27 < local25; local27++) {
			@Pc(33) int local33 = this.method4836();
			@Pc(37) int local37 = this.method4836();
			...
			this.anInt5300 -= 8;
			this.method4813(local33);
			this.method4813(local37);
		}
	...
	public final void method4822(@OriginalArg(0) String arg0) {
		...
		this.anInt5300 += Static350.method5839(arg0.length(), arg0, this.aByteArray73, this.anInt5300);
	...
	public final void method4834(@OriginalArg(0) BigInteger arg0, @OriginalArg(2) BigInteger arg1) {
		...
		this.anInt5300 = 0;
		this.method4842(local39.length);
	...
	public final int method4839() {
		@Pc(12) int local12 = 0;
		@Pc(16) int local16 = this.method4817();
		while (local16 == 32767) {
			local16 = this.method4817();
			local12 += 32767;
		}
			...
			if ((arg0 & 0xFFFFC000) != 0) {
				if ((arg0 & 0xFFE00000) != 0) {
					if ((arg0 & 0xF0000000) != 0) {
						this.method4842(arg0 >>> 28 | 0x80);
					}
					this.method4842(arg0 >>> 21 | 0x80);
				}
				this.method4842(arg0 >>> 14 | 0x80);
			}
			this.method4842(arg0 >>> 7 | 0x80);
		}
		this.method4842(arg0 & 0x7F);
	}
	...
	public final String method4856() {
	...
	public final void method4862(@OriginalArg(0) int[] arg0) {
		...
		for (@Pc(22) int local22 = 0; local22 < local17; local22++) {
			@Pc(28) int local28 = this.method4836();
			@Pc(32) int local32 = this.method4836();
			@Pc(34) int local34 = 0;
			...
			this.anInt5300 -= 8;
			this.method4813(local28);
			this.method4813(local32);
		}
	}
