...
public final class Static48 {
	...
	public static final int[] anIntArray497 = new int[1];
	...
	@OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lclient!jaggl/opengl;IIIIII[I)V")
	public static void method5448(@OriginalArg(0) opengl arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int[] arg6) {
		if (arg3 > 0 && !Static272.method4899(arg3)) {
			throw new IllegalArgumentException("");
		} else if (arg4 <= 0 || Static272.method4899(arg4)) {
			@Pc(31) int local31 = 0;
	...
	@OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lclient!jaggl/opengl;IIIII[B)V")
	public static void method5450(@OriginalArg(0) opengl arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) byte[] arg6) {
		if (arg3 > 0 && !Static272.method4899(arg3)) {
			throw new IllegalArgumentException("");
		} else if (arg4 <= 0 || Static272.method4899(arg4)) {
			@Pc(24) int local24 = method5456(arg5);
			@Pc(26) int local26 = 0;
	...
	public static int method5456(@OriginalArg(0) int arg0) {
		if (arg0 == 6406) {
			return 1;
		} else if (arg0 == 6409) {
			return 1;
	...
	@OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lclient!jaggl/opengl;IIIII[F)V")
	public static void method5457(@OriginalArg(0) opengl arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6) {
		if (arg3 > 0 && !Static272.method4899(arg3)) {
			throw new IllegalArgumentException("");
		} else if (arg4 <= 0 || Static272.method4899(arg4)) {
			@Pc(24) int local24 = method5456(6408);
			@Pc(26) int local26 = 0;
			@Pc(33) int local33 = arg3 < arg4 ? arg3 : arg4;
			@Pc(37) int local37 = arg3 >> 1;
			@Pc(41) int local41 = arg4 >> 1;
