...
public abstract class Class31 {
	...
	public abstract Class31 method3800(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2);
	...
	public abstract void method3803(@OriginalArg(0) Class31 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4);
	...
	public final void method3818(@OriginalArg(0) Class2_Sub2_Sub13 arg0, @OriginalArg(2) int arg1) {
		...
		for (@Pc(28) int local28 = 0; local28 < local19.anInt4048; local28++) {
			...
			if (local22.aBooleanArray25[local35]) {
				...
				this.method3825(local22.anIntArray168[local35], local19.aShortArray81[local28], local19.aShortArray87[local28], local19.aShortArray88[local28]);
			}
		}
		this.method3836();
	}
	...
	public final void method3823(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub2_Sub13 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Class2_Sub2_Sub13 arg6, @OriginalArg(8) boolean arg7, @OriginalArg(10) int[] arg8) {
	...
	public final void method3828(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub2_Sub13 arg1, @OriginalArg(2) int arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Class2_Sub2_Sub13 arg6, @OriginalArg(8) int arg7) {
		...
		if (arg9 == null || arg7 == 0) {
			for (local18 = 0; local18 < arg4.anInt4048; local18++) {
				...
				if (arg3 == null || arg0 == arg3[local25] || arg2.anIntArray168[local25] == 0) {
					...
					if (local49 != -1) {
						this.method3846(0, 0, arg1, arg5 & arg2.anIntArray169[local49], 0, arg2.anIntArrayArray21[local49], arg8, arg6, 0);
					}
					this.method3846(arg4.aShortArray87[local18], arg2.anIntArray168[local25], arg1, arg5 & arg2.anIntArray169[local25], arg4.aShortArray88[local18], arg2.anIntArrayArray21[local25], arg8, arg6, arg4.aShortArray81[local18]);
				}
			}
			return;
		}
		...
		for (@Pc(121) int local121 = 0; local121 < arg2.anInt2679; local121++) {
			...
			if (local125 || local143) {
				if (arg3 == null || arg0 == arg3[local121] || arg2.anIntArray168[local121] == 0) {
					...
					if (local213 != -1) {
						this.method3846(0, 0, arg1, arg2.anIntArray169[local213] & arg5, 0, arg2.anIntArrayArray21[local213], arg8, arg6, 0);
					} else if (local255 != -1) {
						this.method3846(0, 0, arg1, arg5 & arg2.anIntArray169[local255], 0, arg2.anIntArrayArray21[local255], arg8, arg6, 0);
					}
					@Pc(396) int local396;
					@Pc(406) int local406;
					@Pc(420) int local420;
					...
					this.method3846(local406, local198, arg1, arg5 & arg2.anIntArray169[local121], local420, arg2.anIntArrayArray21[local121], arg8, arg6, local396);
				} else {
					if (local143) {
						local119++;
					}
