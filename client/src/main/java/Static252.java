...
public final class Static252 {
	...
	public static void method4365(@OriginalArg(0) boolean arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 0) {
			Rasteriser.textureProvider = Static387.method2822(client.preferences.antiAliasingMode * 2, GameShell.signlink, Static128.anInterface2_4, GameShell.canvas, arg1);
		} else {
			if (arg0) {
				Rasteriser.textureProvider = Static387.method2822(0, GameShell.signlink, Static128.anInterface2_4, GameShell.canvas, 0);
				Rasteriser.textureProvider.method2867(0);
				@Pc(22) Class239 local22 = Static101.method2165(Sprites.p12FullId, client.jsArchive13);
				@Pc(31) BitmapFont local31 = Rasteriser.textureProvider.method2857(local22, Static396.method1688(client.jsArchive8, Sprites.p12FullId));
		...
		if (Rasteriser.textureProvider.method2849()) {
			@Pc(97) Class2_Sub22 local97 = Rasteriser.textureProvider.method2876();
			Rasteriser.textureProvider.method2846(local97);
		}
		...
		Static76.aClass14_3 = Rasteriser.textureProvider.method2897();
		Static232.aClass14_4 = Rasteriser.textureProvider.method2897();
		@Pc(127) int local127 = (int) ((double) Static373.anInt7033 * 34.46D);
		if (Rasteriser.textureProvider.method2888()) {
			local127 += 128;
		}
		Rasteriser.textureProvider.method2872(50, local127);
		Rasteriser.textureProvider.method2874(!client.preferences.highDetailTextures);
		if (Rasteriser.textureProvider.method2858()) {
