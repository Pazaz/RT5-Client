...
public final class Class42 {
	...
	private final PacketGl aPacketGl = new PacketGl(786336);
	...
	private void method1077(@OriginalArg(1) Class19_Sub3 arg0, @OriginalArg(2) int arg1) {
			...
			for (local99 = arg1 - 1; local99 >= 0; local99--) {
				...
				if (local117 > 0) {
					for (local123 = local117 - 1; local123 >= 0; local123--) {
						...
						this.aPacketGl.pFloat(0.0F);
						this.aPacketGl.pFloat(0.0F);
						this.aPacketGl.pFloat(local161 + (float) -local178 * local54);
						this.aPacketGl.pFloat((float) -local178 * local58 + local167);
						this.aPacketGl.pFloat((float) -local178 * local62 + local173);
						this.aPacketGl.p1(local142);
						this.aPacketGl.p1(local147);
						this.aPacketGl.p1(local150);
						this.aPacketGl.p1(local155);
						this.aPacketGl.pFloat(1.0F);
						this.aPacketGl.pFloat(0.0F);
						this.aPacketGl.pFloat(local161 + (float) local178 * local66);
						this.aPacketGl.pFloat((float) local178 * local71 + local167);
						this.aPacketGl.pFloat(local173 + (float) local178 * local75);
						this.aPacketGl.p1(local142);
						this.aPacketGl.p1(local147);
						this.aPacketGl.p1(local150);
						this.aPacketGl.p1(local155);
						this.aPacketGl.pFloat(1.0F);
						this.aPacketGl.pFloat(1.0F);
						this.aPacketGl.pFloat(local54 * (float) local178 + local161);
						this.aPacketGl.pFloat(local167 + (float) local178 * local58);
						this.aPacketGl.pFloat(local173 + local62 * (float) local178);
						this.aPacketGl.p1(local142);
						this.aPacketGl.p1(local147);
						this.aPacketGl.p1(local150);
						this.aPacketGl.p1(local155);
						this.aPacketGl.pFloat(0.0F);
						this.aPacketGl.pFloat(1.0F);
						this.aPacketGl.pFloat(local80 * (float) local178 + local161);
						this.aPacketGl.pFloat(local167 + (float) local178 * local84);
						this.aPacketGl.pFloat(local173 + local88 * (float) local178);
						this.aPacketGl.p1(local142);
						this.aPacketGl.p1(local147);
						this.aPacketGl.p1(local150);
						this.aPacketGl.p1(local155);
					...
					if (this.anIntArray74[local99] > 64) {
						...
						for (local137 = this.anIntArray76[local448] - 1; local137 >= 0; local137--) {
							...
							this.aPacketGl.pFloat(0.0F);
							this.aPacketGl.pFloat(0.0F);
							this.aPacketGl.pFloat((float) -local508 * local54 + local173);
							this.aPacketGl.pFloat(local58 * (float) -local508 + local497);
							this.aPacketGl.pFloat((float) -local508 * local62 + local503);
							this.aPacketGl.p1(local150);
							this.aPacketGl.p1(local155);
							this.aPacketGl.p1(local480);
							this.aPacketGl.p1(local485);
							this.aPacketGl.pFloat(1.0F);
							this.aPacketGl.pFloat(0.0F);
							this.aPacketGl.pFloat((float) local508 * local66 + local173);
							this.aPacketGl.pFloat(local497 + local71 * (float) local508);
							this.aPacketGl.pFloat((float) local508 * local75 + local503);
							this.aPacketGl.p1(local150);
							this.aPacketGl.p1(local155);
							this.aPacketGl.p1(local480);
							this.aPacketGl.p1(local485);
							this.aPacketGl.pFloat(1.0F);
							this.aPacketGl.pFloat(1.0F);
							this.aPacketGl.pFloat(local173 + local54 * (float) local508);
							this.aPacketGl.pFloat(local497 + local58 * (float) local508);
							this.aPacketGl.pFloat(local62 * (float) local508 + local503);
							this.aPacketGl.p1(local150);
							this.aPacketGl.p1(local155);
							this.aPacketGl.p1(local480);
							this.aPacketGl.p1(local485);
							this.aPacketGl.pFloat(0.0F);
							this.aPacketGl.pFloat(1.0F);
							this.aPacketGl.pFloat(local173 + local80 * (float) local508);
							this.aPacketGl.pFloat(local497 + (float) local508 * local84);
							this.aPacketGl.pFloat(local88 * (float) local508 + local503);
							this.aPacketGl.p1(local150);
							this.aPacketGl.p1(local155);
							this.aPacketGl.p1(local480);
							this.aPacketGl.p1(local485);
			...
			for (local99 = arg1 - 1; local99 >= 0; local99--) {
				...
				if (local117 > 0) {
					for (local123 = local117 - 1; local123 >= 0; local123--) {
						...
						local173 = (float) (local134.anInt7536 >> 12);
						local178 = local134.anInt7535 >> 12;
						this.aPacketGl.ipFloat(0.0F);
						this.aPacketGl.ipFloat(0.0F);
						this.aPacketGl.ipFloat(local54 * (float) -local178 + local161);
						this.aPacketGl.ipFloat((float) -local178 * local58 + local167);
						this.aPacketGl.ipFloat(local62 * (float) -local178 + local173);
						this.aPacketGl.p1(local142);
						this.aPacketGl.p1(local147);
						this.aPacketGl.p1(local150);
						this.aPacketGl.p1(local155);
						this.aPacketGl.ipFloat(1.0F);
						this.aPacketGl.ipFloat(0.0F);
						this.aPacketGl.ipFloat(local66 * (float) local178 + local161);
						this.aPacketGl.ipFloat(local167 + (float) local178 * local71);
						this.aPacketGl.ipFloat(local173 + local75 * (float) local178);
						this.aPacketGl.p1(local142);
						this.aPacketGl.p1(local147);
						this.aPacketGl.p1(local150);
						this.aPacketGl.p1(local155);
						...
						this.aPacketGl.ipFloat(local54 * (float) local178 + local161);
						this.aPacketGl.ipFloat((float) local178 * local58 + local167);
						this.aPacketGl.ipFloat(local173 + (float) local178 * local62);
						this.aPacketGl.p1(local142);
						this.aPacketGl.p1(local147);
						this.aPacketGl.p1(local150);
						this.aPacketGl.p1(local155);
						this.aPacketGl.ipFloat(0.0F);
						this.aPacketGl.ipFloat(1.0F);
						this.aPacketGl.ipFloat((float) local178 * local80 + local161);
						this.aPacketGl.ipFloat(local167 + (float) local178 * local84);
						this.aPacketGl.ipFloat((float) local178 * local88 + local173);
						this.aPacketGl.p1(local142);
						this.aPacketGl.p1(local147);
						this.aPacketGl.p1(local150);
						this.aPacketGl.p1(local155);
					...
					if (this.anIntArray74[local99] > 64) {
						...
						for (local137 = this.anIntArray76[local448] - 1; local137 >= 0; local137--) {
							...
							this.aPacketGl.ipFloat(0.0F);
							this.aPacketGl.ipFloat(0.0F);
							this.aPacketGl.ipFloat(local173 + local54 * (float) -local508);
							this.aPacketGl.ipFloat(local58 * (float) -local508 + local497);
							this.aPacketGl.ipFloat((float) -local508 * local62 + local503);
							this.aPacketGl.p1(local150);
							this.aPacketGl.p1(local155);
							this.aPacketGl.p1(local480);
							this.aPacketGl.p1(local485);
							this.aPacketGl.ipFloat(1.0F);
							this.aPacketGl.ipFloat(0.0F);
							this.aPacketGl.ipFloat(local66 * (float) local508 + local173);
							this.aPacketGl.ipFloat((float) local508 * local71 + local497);
							this.aPacketGl.ipFloat(local75 * (float) local508 + local503);
							this.aPacketGl.p1(local150);
							this.aPacketGl.p1(local155);
							this.aPacketGl.p1(local480);
							this.aPacketGl.p1(local485);
							...
							this.aPacketGl.ipFloat(1.0F);
							this.aPacketGl.ipFloat(local173 + local54 * (float) local508);
							this.aPacketGl.ipFloat((float) local508 * local58 + local497);
							this.aPacketGl.ipFloat((float) local508 * local62 + local503);
							this.aPacketGl.p1(local150);
							this.aPacketGl.p1(local155);
							this.aPacketGl.p1(local480);
							...
							this.aPacketGl.ipFloat(0.0F);
							this.aPacketGl.ipFloat(1.0F);
							this.aPacketGl.ipFloat(local173 + local80 * (float) local508);
							this.aPacketGl.ipFloat(local84 * (float) local508 + local497);
							this.aPacketGl.ipFloat(local503 + (float) local508 * local88);
							this.aPacketGl.p1(local150);
							this.aPacketGl.p1(local155);
							this.aPacketGl.p1(local480);
							this.aPacketGl.p1(local485);
		...
		if (this.aPacketGl.pos != 0) {
			this.anInterface12_1.method5002(this.aPacketGl.data, this.aPacketGl.pos, 24);
			arg0.method7039(this.aClass94_2, (Class94) null, this.aClass94_1, this.aClass94_3);
			arg0.method6998(this.aPacketGl.pos / 24);
		}
	}
