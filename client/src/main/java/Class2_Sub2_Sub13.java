...
public final class Class2_Sub2_Sub13 extends Class2_Sub2 {
	...
	public boolean method4240() {
		...
		if (this.aByteArrayArray11 == null) {
			if (!Static392.aClass197_97.method5071(this.anInt4499)) {
				return false;
			}
			@Pc(27) int[] local27 = Static392.aClass197_97.method5077(this.anInt4499);
			this.aByteArrayArray11 = new byte[local27.length][];
			for (local34 = 0; local34 < local27.length; local34++) {
				this.aByteArrayArray11[local34] = Static392.aClass197_97.method5089(local27[local34], this.anInt4499);
			}
		}
		...
		for (local34 = 0; local34 < this.aByteArrayArray11.length; local34++) {
			...
			local55 &= Static78.aClass197_89.method5087(local78);
		}
		if (!local55) {
			return false;
		}
		@Pc(103) Class135 local103 = new Class135();
		local78 = Static392.aClass197_97.method5081(this.anInt4499);
		this.aClass159Array1 = new Class159[local78];
		@Pc(119) int[] local119 = Static392.aClass197_97.method5077(this.anInt4499);
		for (@Pc(121) int local121 = 0; local121 < local119.length; local121++) {
			...
			for (@Pc(149) Class2_Sub18 local149 = (Class2_Sub18) local103.method3551(); local149 != null; local149 = (Class2_Sub18) local103.method3552()) {
			...
			if (local144 == null) {
				local144 = new Class2_Sub18(local142, Static78.aClass197_89.method5082(local142));
				local103.method3540(local144);
			}
