...
public final class Class12_Sub8 extends ParticleNode {
	...
	public Class12_Sub8(@OriginalArg(0) RasteriserBase arg0, @OriginalArg(1) Class114 arg1, @OriginalArg(2) ParticleSystem arg2, @OriginalArg(3) long arg3) {
	...
	public void method5686(@OriginalArg(0) long arg0, @OriginalArg(2) RasteriserBase arg1, @OriginalArg(3) int arg2, @OriginalArg(4) boolean arg3) {
		@Pc(54) int local54;
		if (this.aBoolean422) {
			arg3 = false;
			...
			if (this.anInt6244 > 63) {
				...
				for (@Pc(147) int local147 = 0; local147 < local54; local147++) {
					...
					if (this.aClass235_1.aShort95 <= 0 && this.aClass235_1.aShort96 <= 0) {
						...
						local175 = RasteriserBase.anIntArray178[local171];
						local179 = RasteriserBase.anIntArray177[local171];
						local189 = (int) ((double) this.anInt6237 * Math.random()) + this.anInt6260;
						@Pc(193) int local193 = local189 & 0x1FFF;
						local197 = RasteriserBase.anIntArray178[local193];
						local201 = RasteriserBase.anIntArray177[local193];
