...
public final class SoundBank {
	...
	private PcmSound method873(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		@Pc(15) int local15 = (arg2 >>> 12 | arg2 << 4 & 0xFFF8) ^ arg0;
		@Pc(21) int local21 = local15 | arg2 << 16;
		@Pc(24) long local24 = (long) local21;
		@Pc(31) PcmSound local31 = (PcmSound) this.aClass4_12.get(local24);
		if (local31 != null) {
			return local31;
		} else if (arg1 == null || arg1[0] > 0) {
			@Pc(54) SynthSound local54 = Static409.method6435(this.aClass197_3, arg2, arg0);
			if (local54 == null) {
				return null;
			}
	...
	private PcmSound method874(@OriginalArg(0) int arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2) {
		...
		@Pc(33) PcmSound local33 = (PcmSound) this.aClass4_12.get(local26);
		if (local33 != null) {
			return local33;
		} else if (arg1 == null || arg1[0] > 0) {
