...
public final class Class188 {
	...
	private void method4768(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub4 arg1) {
		if (arg0 == 1) {
			...
			this.aString55 = arg1.method4809();
		} else if (arg0 == 4) {
			this.anInt5241 = arg1.method4829();
		} else if (arg0 == 5) {
			this.anInt5245 = arg1.method4829();
		} else if (arg0 == 6) {
			this.anInt5215 = arg1.method4829();
		} else if (arg0 == 7) {
			this.anInt5252 = arg1.method4829();
			if (this.anInt5252 > 32767) {
				this.anInt5252 -= 65536;
			}
		} else if (arg0 == 8) {
			this.anInt5232 = arg1.method4829();
			...
			this.anInt5205 = arg1.method4829();
		} else if (arg0 == 24) {
			this.anInt5248 = arg1.method4829();
		} else if (arg0 == 25) {
			this.anInt5250 = arg1.method4829();
		} else if (arg0 == 26) {
			this.anInt5211 = arg1.method4829();
		} else if (arg0 >= 30 && arg0 < 35) {
			this.aStringArray50[arg0 - 30] = arg1.method4809();
		} else if (arg0 >= 35 && arg0 < 40) {
			this.aStringArray51[arg0 - 35] = arg1.method4809();
		} else {
			@Pc(162) int local162;
			@Pc(172) int local172;
			if (arg0 == 40) {
				...
				for (local172 = 0; local172 < local162; local172++) {
					this.aShortArray113[local172] = (short) arg1.method4829();
				...
				for (local172 = 0; local172 < local162; local172++) {
					this.aShortArray111[local172] = (short) arg1.method4829();
				...
				this.anInt5201 = arg1.method4829();
			} else if (arg0 == 79) {
				this.anInt5207 = arg1.method4829();
			} else if (arg0 == 90) {
				this.anInt5208 = arg1.method4829();
			} else if (arg0 == 91) {
				this.anInt5200 = arg1.method4829();
			} else if (arg0 == 92) {
				this.anInt5251 = arg1.method4829();
			} else if (arg0 == 93) {
				this.anInt5243 = arg1.method4829();
			} else if (arg0 == 95) {
				...
				this.anInt5258 = arg1.method4829();
			} else if (arg0 >= 100 && arg0 < 110) {
				if (this.anIntArray365 == null) {
					this.anIntArray366 = new int[10];
					this.anIntArray365 = new int[10];
				}
				this.anIntArray365[arg0 - 100] = arg1.method4829();
				this.anIntArray366[arg0 - 100] = arg1.method4829();
			} else if (arg0 == 110) {
				this.anInt5233 = arg1.method4829();
			} else if (arg0 == 111) {
				this.anInt5226 = arg1.method4829();
			} else if (arg0 == 112) {
				this.anInt5261 = arg1.method4829();
			} else if (arg0 == 113) {
				this.anInt5256 = arg1.method4825();
			} else if (arg0 == 114) {
				...
				this.anInt5235 = arg1.method4829();
			} else if (arg0 == 125) {
				this.anInt5213 = arg1.method4825();
				this.anInt5206 = arg1.method4825();
				this.anInt5260 = arg1.method4825();
			} else if (arg0 == 126) {
				this.anInt5222 = arg1.method4825();
	...
	public Class31 method4776(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class157 arg3, @OriginalArg(5) Class19 arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Class117 arg6, @OriginalArg(8) int arg7) {
		@Pc(15) int local15;
		if (this.anIntArray365 != null && arg5 > 1) {
			...
			if (local15 != -1) {
				return this.aClass107_1.method2759(local15).method4776(arg0, arg1, arg2, arg3, arg4, 1, arg6, arg7);
			}
		}
		local15 = arg1;
		if (arg3 != null) {
			...
			if (arg6 != null) {
				for (local229 = 0; local229 < 5; local229++) {
					if (Static353.aShortArrayArray7[local229].length > arg6.anIntArray194[local229]) {
						local102.method3838(Static10.aShortArray1[local229], Static353.aShortArrayArray7[local229][arg6.anIntArray194[local229]]);
					}
	...
	public void method4780(@OriginalArg(1) Class188 arg0, @OriginalArg(2) Class188 arg1) {
	...
	public int[] method4781(@OriginalArg(0) Class130 arg0, @OriginalArg(1) Class117 arg1, @OriginalArg(3) Class19 arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Class19 arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) boolean arg8) {
		...
		if (arg1 != null) {
			for (local23 = 0; local23 < 5; local23++) {
				if (arg1.anIntArray194[local23] < Static353.aShortArrayArray7[local23].length) {
					local14.method4663(Static10.aShortArray1[local23], Static353.aShortArrayArray7[local23][arg1.anIntArray194[local23]]);
				}
		...
		local333.method3936(this.anInt5252, (Class19.anIntArray178[this.anInt5245 << 3] * local287 >> 15) + (this.anInt5232 - (local210.method3802() / 2)), this.anInt5232 + (local287 * Class19.anIntArray177[this.anInt5245 << 3] >> 15));
	...
	public Class188 method4782(@OriginalArg(0) int arg0) {
	...
	public void method4784(@OriginalArg(0) Class188 arg0, @OriginalArg(1) Class188 arg1) {
