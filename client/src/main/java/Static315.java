...
public final class Static315 {
	...
	public static void method5382() {
		...
		@Pc(13) int local13 = Static212.aClass2_Sub4_Sub2_3.method4868(8);
		@Pc(18) int local18;
		...
		for (local18 = 0; local18 < local13; local18++) {
			...
			@Pc(73) int local73 = Static212.aClass2_Sub4_Sub2_3.method4868(1);
			if (local73 == 0) {
				Static211.anIntArray230[Static166.anInt3187++] = local64;
				local68.anInt4610 = Static114.anInt2348;
			} else {
				@Pc(96) int local96 = Static212.aClass2_Sub4_Sub2_3.method4868(2);
				if (local96 == 0) {
					Static211.anIntArray230[Static166.anInt3187++] = local64;
					local68.anInt4610 = Static114.anInt2348;
					...
					if (local96 == 1) {
						Static211.anIntArray230[Static166.anInt3187++] = local64;
						local68.anInt4610 = Static114.anInt2348;
						local140 = Static212.aClass2_Sub4_Sub2_3.method4868(3);
						local68.method4338(1, local140);
						local150 = Static212.aClass2_Sub4_Sub2_3.method4868(1);
						if (local150 == 1) {
							Static277.anIntArray361[Static343.anInt6390++] = local64;
						}
					} else if (local96 == 2) {
						Static211.anIntArray230[Static166.anInt3187++] = local64;
						local68.anInt4610 = Static114.anInt2348;
						if (Static212.aClass2_Sub4_Sub2_3.method4868(1) == 1) {
							local140 = Static212.aClass2_Sub4_Sub2_3.method4868(3);
							local68.method4338(2, local140);
							local150 = Static212.aClass2_Sub4_Sub2_3.method4868(3);
							local68.method4338(2, local150);
						} else {
							local140 = Static212.aClass2_Sub4_Sub2_3.method4868(3);
							local68.method4338(0, local140);
						}
						local140 = Static212.aClass2_Sub4_Sub2_3.method4868(1);
						if (local140 == 1) {
							Static277.anIntArray361[Static343.anInt6390++] = local64;
						}
					} else if (local96 == 3) {
