			...
			for (@Pc(57) int local57 = 0; local57 < local43; local57++) {
				...
				if (local72 > 0) {
					...
					if ((local72 & 0x1) == 0) {
						...
						Static413.aShortArray91[local45] = (short) local29.gSmart1or2s();
					}
					if ((local72 & 0x2) == 0) {
						Static413.aShortArray88[local45] = local87;
					} else {
						Static413.aShortArray88[local45] = (short) local29.gSmart1or2s();
					}
					if ((local72 & 0x4) == 0) {
						Static413.aShortArray90[local45] = local87;
					} else {
						Static413.aShortArray90[local45] = (short) local29.gSmart1or2s();
					}
