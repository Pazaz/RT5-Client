...
public final class Class2_Sub4_Sub2 extends Buffer {
	...
	public int method4864() {
		@Pc(22) int local22 = super.aByteArray73[super.position++] - this.aClass217_1.method5534() & 0xFF;
		return local22 < 128 ? local22 : (super.aByteArray73[super.position++] - this.aClass217_1.method5534() & 0xFF) + (local22 - 128 << 8);
	}

	@OriginalMember(owner = "client!qg", name = "r", descriptor = "(B)V")
	public void method4865() {
		super.position = (this.anInt5340 + 7) / 8;
	}
	...
	public void method4866(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		for (@Pc(12) int local12 = 0; local12 < arg1; local12++) {
			arg0[local12] = (byte) (super.aByteArray73[super.position++] - this.aClass217_1.method5534());
		}
	}

	@OriginalMember(owner = "client!qg", name = "k", descriptor = "(II)V")
	public void method4867(@OriginalArg(0) int arg0) {
		super.aByteArray73[super.position++] = (byte) (this.aClass217_1.method5534() + arg0);
	}
	...
	public void method4869() {
		this.anInt5340 = super.position * 8;
	}

	@OriginalMember(owner = "client!qg", name = "s", descriptor = "(B)Z")
	public boolean method4870() {
		@Pc(17) int local17 = super.aByteArray73[super.position] - this.aClass217_1.method5533() & 0xFF;
		return local17 >= 128;
	}
