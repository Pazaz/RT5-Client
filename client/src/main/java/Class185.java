...
public final class Class185 {
	...
	public void method4664(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(32) int local32;
		if (arg1 != 0) {
			local7 = RasteriserBase.anIntArray178[arg1];
			local11 = RasteriserBase.anIntArray177[arg1];
		...
		if (arg2 != 0) {
			local7 = RasteriserBase.anIntArray178[arg2];
			local11 = RasteriserBase.anIntArray177[arg2];
			for (local13 = 0; local13 < this.anInt5075; local13++) {
		...
		local7 = RasteriserBase.anIntArray178[arg0];
		local11 = RasteriserBase.anIntArray177[arg0];
		for (local13 = 0; local13 < this.anInt5075; local13++) {
