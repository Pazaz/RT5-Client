...
public final class Class143 {
	...
	private void method3687(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1) {
			...
			for (local83 = arg1 - 1; local83 >= 0; local83--) {
				...
				if (local98 > 0) {
					for (local104 = local98 - 1; local104 >= 0; local104--) {
						...
						this.aClass2_Sub4_Sub1_2.method4842(local121);
						this.aClass2_Sub4_Sub1_2.method4842(local126);
						this.aClass2_Sub4_Sub1_2.method4842(local129);
						this.aClass2_Sub4_Sub1_2.method4842(local134);
					...
					if (this.anIntArray223[local83] > 64) {
						...
						for (local424 = this.anIntArray222[local104] - 1; local424 >= 0; local424--) {
							...
							this.aClass2_Sub4_Sub1_2.method4842(local129);
							this.aClass2_Sub4_Sub1_2.method4842(local134);
							this.aClass2_Sub4_Sub1_2.method4842(local454);
							this.aClass2_Sub4_Sub1_2.method3059(1.0F);
							this.aClass2_Sub4_Sub1_2.method3059(0.0F);
		...
		if (this.aClass2_Sub4_Sub1_2.anInt5300 != 0) {
			this.anInterface5_5.method4602(24, this.aClass2_Sub4_Sub1_2.aByteArray73, this.aClass2_Sub4_Sub1_2.anInt5300);
