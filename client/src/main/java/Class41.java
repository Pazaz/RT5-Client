...
public final class Class41 {
	...
	public Class31 method1518(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class6 arg2, @OriginalArg(3) int arg3, @OriginalArg(5) Class157 arg4, @OriginalArg(6) int arg5, @OriginalArg(7) Class19 arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class6 arg8, @OriginalArg(10) int arg9, @OriginalArg(11) int arg10, @OriginalArg(12) int arg11, @OriginalArg(13) int arg12) {
		...
		if (this.aByte6 != 0) {
			...
			local117.method3819(this.aByte6, this.aShort16, arg2, arg8, arg10, arg9, arg11);
		}
		if (local172) {
	...
	public Class105 method1519(@OriginalArg(0) int arg0, @OriginalArg(1) Class6 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) boolean arg6, @OriginalArg(8) Class19 arg7, @OriginalArg(9) Class6 arg8, @OriginalArg(10) int arg9) {
		...
		if (this.aByte6 == 0 || arg1 == null && arg8 == null) {
			...
			local108.method3819(this.aByte6, this.aShort16, arg1, arg8, arg4, arg0, arg3);
	...
	public boolean method1522() {
		...
		for (@Pc(22) int local22 = 0; local22 < this.anIntArray94.length; local22++) {
			if (this.anIntArray94[local22] != -1) {
				@Pc(46) Class41 local46 = this.aClass202_1.method5163(this.anIntArray94[local22]);
	...
	private void method1523(@OriginalArg(1) Class2_Sub4 arg0, @OriginalArg(2) int arg1) {
		...
		if (arg1 == 1) {
			...
			if (local12 > 0) {
				if (this.anIntArray92 == null || this.aClass202_1.aBoolean400) {
					...
					for (local31 = 0; local31 < local12; local31++) {
						this.anIntArray92[local31] = arg0.method4829();
						this.anIntArray97[local31] = arg0.method4815();
					}
				} else {
			...
			this.aString12 = arg0.method4809();
		} else if (arg1 == 5) {
			local12 = arg0.method4815();
			if (local12 > 0) {
				if (this.anIntArray92 == null || this.aClass202_1.aBoolean400) {
			...
			this.anInt1356 = arg0.method4815();
		} else if (arg1 == 15) {
			this.anInt1327 = arg0.method4815();
		} else if (arg1 == 17) {
			...
			this.anInt1335 = arg0.method4815();
		} else if (arg1 == 21) {
			this.aByte6 = 1;
		} else if (arg1 == 22) {
			...
			this.anInt1326 = arg0.method4829();
			...
			this.anInt1340 = arg0.method4815();
		} else if (arg1 == 29) {
			this.anInt1348 = arg0.method4825();
		} else if (arg1 == 39) {
			this.anInt1343 = arg0.method4825() * 5;
		} else if (arg1 >= 30 && arg1 < 35) {
			this.aStringArray10[arg1 - 30] = arg0.method4809();
		} else if (arg1 == 40) {
			local12 = arg0.method4815();
			this.aShortArray22 = new short[local12];
			this.aShortArray23 = new short[local12];
			for (local31 = 0; local31 < local12; local31++) {
				this.aShortArray22[local31] = (short) arg0.method4829();
				this.aShortArray23[local31] = (short) arg0.method4829();
			}
		} else if (arg1 == 41) {
			local12 = arg0.method4815();
			...
			for (local31 = 0; local31 < local12; local31++) {
				this.aShortArray21[local31] = (short) arg0.method4829();
				this.aShortArray24[local31] = (short) arg0.method4829();
			}
		} else if (arg1 == 42) {
			local12 = arg0.method4815();
			this.aByteArray15 = new byte[local12];
			for (local31 = 0; local31 < local12; local31++) {
				this.aByteArray15[local31] = arg0.method4825();
			}
		} else if (arg1 == 62) {
			...
			this.anInt1350 = arg0.method4829();
		} else if (arg1 == 66) {
			this.anInt1319 = arg0.method4829();
		} else if (arg1 == 67) {
			this.anInt1355 = arg0.method4829();
		} else if (arg1 == 69) {
			this.anInt1342 = arg0.method4815();
		} else if (arg1 == 70) {
			this.anInt1308 = arg0.method4823();
		} else if (arg1 == 71) {
			this.anInt1330 = arg0.method4823();
		} else if (arg1 == 72) {
			this.anInt1333 = arg0.method4823();
		} else if (arg1 == 73) {
			this.aBoolean117 = true;
		} else if (arg1 == 74) {
			this.aBoolean105 = true;
		} else if (arg1 == 75) {
			this.anInt1354 = arg0.method4815();
		} else {
			@Pc(462) int local462;
			if (arg1 == 77 || arg1 == 92) {
				this.anInt1339 = arg0.method4829();
				if (this.anInt1339 == 65535) {
					this.anInt1339 = -1;
				}
				this.anInt1338 = arg0.method4829();
				if (this.anInt1338 == 65535) {
					this.anInt1338 = -1;
				}
				local12 = -1;
				if (arg1 == 92) {
					local12 = arg0.method4829();
					if (local12 == 65535) {
						local12 = -1;
					}
				}
				local31 = arg0.method4815();
				this.anIntArray94 = new int[local31 + 2];
				for (local462 = 0; local462 <= local31; local462++) {
					this.anIntArray94[local462] = arg0.method4829();
				...
				this.anInt1325 = arg0.method4829();
				this.anInt1307 = arg0.method4815();
			} else if (arg1 == 79) {
				this.anInt1334 = arg0.method4829();
				this.anInt1315 = arg0.method4829();
				this.anInt1307 = arg0.method4815();
				local12 = arg0.method4815();
				this.anIntArray93 = new int[local12];
				for (local31 = 0; local31 < local12; local31++) {
					this.anIntArray93[local31] = arg0.method4829();
				}
			} else if (arg1 == 81) {
				this.aByte6 = 2;
				this.aShort16 = (short) (arg0.method4815() * 256);
			} else if (arg1 == 82) {
				...
				this.aByte6 = 3;
				this.aShort16 = (short) arg0.method4829();
			} else if (arg1 == 94) {
				this.aByte6 = 4;
			} else if (arg1 == 95) {
				this.aByte6 = 5;
				...
				this.anInt1344 = arg0.method4815();
				this.anInt1312 = arg0.method4829();
			} else if (arg1 == 100) {
				this.anInt1341 = arg0.method4815();
				this.anInt1313 = arg0.method4829();
			} else if (arg1 == 101) {
				this.anInt1309 = arg0.method4815();
			} else if (arg1 == 102) {
				this.anInt1316 = arg0.method4829();
			} else if (arg1 == 103) {
				this.anInt1321 = 0;
			} else if (arg1 == 104) {
				this.anInt1320 = arg0.method4815();
			} else if (arg1 == 105) {
				...
				for (local31 = 0; local31 < local12; local31++) {
					this.anIntArray95[local31] = arg0.method4829();
					local462 = arg0.method4815();
					this.anIntArray91[local31] = local462;
					this.anInt1311 += local462;
				}
			} else if (arg1 == 107) {
				this.anInt1306 = arg0.method4829();
			} else if (arg1 >= 150 && arg1 < 155) {
				this.aStringArray10[arg1 - 150] = arg0.method4809();
				...
				for (local31 = 0; local31 < local12; local31++) {
					this.anIntArray96[local31] = arg0.method4829();
				}
			} else if (arg1 == 249) {
				local12 = arg0.method4815();
				if (this.aClass4_24 == null) {
				...
				for (local31 = 0; local31 < local12; local31++) {
					@Pc(760) boolean local760 = arg0.method4815() == 1;
					@Pc(764) int local764 = arg0.method4833();
					@Pc(775) Class2 local775;
					if (local760) {
						local775 = new Class2_Sub40(arg0.method4809());
					} else {
						local775 = new Class2_Sub39(arg0.method4836());
					}
	...
	private Class31 method1524(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) Class19 arg3) {
		...
		@Pc(493) Class31 local493 = local165.method3800((byte) 0, arg2, true);
		if (local10 != local165.method3805()) {
		...
		if (this.aShortArray22 != null) {
			for (local322 = 0; local322 < this.aShortArray22.length; local322++) {
				local493.method3838(this.aShortArray22[local322], this.aShortArray23[local322]);
			}
		}
		if (this.aShortArray21 != null) {
			for (local322 = 0; local322 < this.aShortArray21.length; local322++) {
				local493.method3816(this.aShortArray21[local322], this.aShortArray24[local322]);
			}
		}
		if (this.anInt1350 != 128 || this.anInt1319 != 128 || this.anInt1355 != 128) {
			local493.method3842(this.anInt1350, this.anInt1319, this.anInt1355);
		}
		if (this.anInt1308 != 0 || this.anInt1330 != 0 || this.anInt1333 != 0) {
			local493.method3813(this.anInt1308, this.anInt1330, this.anInt1333);
		}
	...
	public Class41 method1533(@OriginalArg(1) Interface11 arg0) {
		@Pc(13) int local13 = -1;
		if (this.anInt1339 != -1) {
			local13 = arg0.method5778(this.anInt1339);
		} else if (this.anInt1338 != -1) {
			local13 = arg0.method5777(this.anInt1338);
		}
